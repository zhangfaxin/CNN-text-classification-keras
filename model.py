...
from keras.layers import Reshape, Flatten, Dropout, Concatenate, LSTM
...
embedding = Embedding(input_dim=len(embeddings_matrix), output_dim=embedding_dim, weights=[embeddings_matrix],
...
checkpoint = ModelCheckpoint('./checkpoint/cnn_word_pianpang_weights.{epoch:03d}-{val_acc:.4f}.hdf5', monitor='val_acc',
