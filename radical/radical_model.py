...
print('Loading data')
x, y,x_eval, y_eval,x_eval_review,max_length = load_data()
...
# embedding = Embedding(input_dim=embedding_dim, output_dim=embedding_dim,input_length=sequence_length,trainable=False)(inputs)
...
checkpoint = ModelCheckpoint('../checkpoint/cnn_radical_weights.{epoch:03d}-{val_acc:.4f}.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='auto')
