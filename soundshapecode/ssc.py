...
if __name__ == "__main__":
    ...
    """
    chi_word1 = '少畐'
    chi_word2 = '国蚤喿二畐我爱你神青并马的冯笃抄畐澡尔冯于无娃少畐哇紫狼路爽晕约紫薇路又刘页列而紫粮路掩连哟罗'
    getHanziStrokesDict()
    ...
    test_1 = getSSC(test_1, SSC_ENCODE_WAY)
    test_2 = getSSC(test_2, SSC_ENCODE_WAY)
    print(compute_ssc_similarity.computeSSCSimilaruty(test_1[0],test_2[0],SSC_ENCODE_WAY))
