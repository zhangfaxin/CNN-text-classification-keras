...
from data_helpers import load_word_data
from keras.callbacks import EarlyStopping,TensorBoard
print('Loading data')
x, y, embeddings_matrix, x_eval, y_eval,x_eval_review = load_word_data()
...
checkpoint = ModelCheckpoint('./checkpoint/cnn_sentence_pinyin_weights.{epoch:03d}-{val_acc:.4f}.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='auto')
