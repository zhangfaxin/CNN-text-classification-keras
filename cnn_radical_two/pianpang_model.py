...
checkpoint = ModelCheckpoint('./checkpoint_pianpang/cnn_word_pinyin_pianpang_weights.{epoch:03d}-{val_acc:.4f}.hdf5', monitor='val_acc', verbose=1, save_best_only=True, mode='auto')
