...
print("Traning Model...")
model.fit([X_train,x_train_pinyin], y_train, batch_size=batch_size, epochs=epochs, verbose=1, callbacks=[checkpoint,tbCallBack, early_stopping], validation_data=([X_test,X_test_pinyin], y_test) )  # starts training
